...
import RomanceGrid from '../components/RomanceGrid'
...
const RomanceList = ({ netflixOriginals, products }: Props) => {
  ...
  return (
    ...
    >
      <Head>
        <title>Romance Genre- WeFlixx</title>

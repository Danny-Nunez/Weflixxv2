...
import RealityGrid from '../components/RealityGrid'
...
const RealityList = ({ netflixOriginals, products }: Props) => {
  ...
  return (
    ...
    >
      <Head>
        <title>Reality Genre- WeFlixx</title>

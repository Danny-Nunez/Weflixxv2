...
function DocumentarySlide({ title }: { title: string }) {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      const cacheKey = 'cachedDocumentaryMovies';
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}genre/documentary`;
...
export default DocumentarySlide;

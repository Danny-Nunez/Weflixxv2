...
function ScienceFictionGrid({ title }: { title: string }) {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}genre/science-fiction?page=${currentPage}`;
...
export default ScienceFictionGrid;

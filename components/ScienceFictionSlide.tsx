...
function ScienceFictionSlide({ title }: { title: string }) {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      const cacheKey = 'cachedScienceFictionMovies';
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}genre/science-fiction`;
...
export default ScienceFictionSlide;

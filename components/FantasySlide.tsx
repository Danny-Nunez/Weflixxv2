...
function FantasySlide({ title }: { title: string }) {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      const cacheKey = 'cachedFantasyMovies';
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}genre/fantasy`;
